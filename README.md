...
- 🌱 I'm currently learning **Medusa.js**, **Payload CMS** and advanced **AWS services**
- 💬 Ask me about **JavaScript, TypeScript, React.js, Next.js, Node.js, PostgreSQL, MongoDB, AWS (Lambda, S3, Cognito, SQS, SES, QuickSight)**
...
Designed a scalable commerce backend using Medusa.js, Node.js & PostgreSQL with invite-based Cognito auth, Payload CMS content management, custom SQL reporting views, and real-time dashboards for sales & guest operations.

**CourseKey – Payment Integration Module**
Built a payment module supporting partial payments & installment plans, with dynamic invoicing, real-time payment tracking, and responsive UI using React.js, TypeScript & Material UI — delivered within a 2-month sprint cycle.
